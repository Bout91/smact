...
function WelcomePanel() {
  return (
    <div className="flex flex-col items-center justify-center h-full py-16 text-center">
      ...
      <div className="text-slate-400 text-sm max-w-xl space-y-3 text-left md:text-center">
        <p>
          Το Service Manager Pro είναι μια ολοκληρωμένη πλατφόρμα διαχείρισης
          Μονάδας, φτιαγμένη αποκλειστικά με τη χρήση Τεχνητής Νοημοσύνης.
          Σκοπός του διαμοιρασμού του Προγράμματος είναι η εξέλιξη και
          αναβάθμιση της εφαρμογής, καθώς και η διόρθωση σφαλμάτων μέσα από
          την εμπειρία των Χρηστών.
        </p>
        <p>
          Φιλοδοξία είναι, με την τελειοποίησή της, να παραδοθεί για
          αξιολόγηση στην Ιεραρχία.
        </p>
        <p>
          Πάτα οποιαδήποτε κύρια καρτέλα αριστερά για να δεις τις
